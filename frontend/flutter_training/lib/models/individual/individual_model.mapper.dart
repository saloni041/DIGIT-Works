...
class _IndividualModelCopyWithImpl<$R, $Out extends IndividualModel>
  ...
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>>? get skills =>
      $value.skills != null
          ? ListCopyWith($value.skills!,
              (v, t) => ObjectCopyWith(v, $identity, t), (v) => call(skills: v))
          : null;
  @override
  ListCopyWith<
      $R,
...
class IndividualAddressMapper extends MapperBase<IndividualAddress> {
  static MapperContainer container = MapperContainer(
    mappers: {IndividualAddressMapper()},
      ...
      CommonAuditDetailsMapper.container,
      IndividualLocalityOrWardMapper.container
    });
...
abstract class IndividualAddressCopyWith<$R, $In extends IndividualAddress,
  ...
  CommonAuditDetailsCopyWith<$R, CommonAuditDetails, CommonAuditDetails>?
      get auditDetails;
  IndividualLocalityOrWardCopyWith<$R, IndividualLocalityOrWard,
      IndividualLocalityOrWard>? get locality;
  IndividualLocalityOrWardCopyWith<$R, IndividualLocalityOrWard,
      IndividualLocalityOrWard>? get ward;
  $R call(
      {String? id,
      String? tenantId,
      CommonAuditDetails? auditDetails,
...
class _IndividualAddressCopyWithImpl<$R, $Out extends IndividualAddress>
  ...
  IndividualLocalityOrWardCopyWith<$R, IndividualLocalityOrWard,
          IndividualLocalityOrWard>?
      get ward => $value.ward?.copyWith.chain($identity, (v) => call(ward: v));
  @override
  $R call(
          {Object? id = $none,
          Object? tenantId = $none,
...
class IndividualLocalityOrWardMapper
    extends MapperBase<IndividualLocalityOrWard> {
  static MapperContainer container = MapperContainer(
    mappers: {IndividualLocalityOrWardMapper()},
  );

  @override
  IndividualLocalityOrWardMapperElement createElement(
      MapperContainer container) {
    return IndividualLocalityOrWardMapperElement._(this, container);
  }

  @override
  String get id => 'IndividualLocalityOrWard';

  static final fromMap = container.fromMap<IndividualLocalityOrWard>;
  static final fromJson = container.fromJson<IndividualLocalityOrWard>;
}

class IndividualLocalityOrWardMapperElement
    extends MapperElementBase<IndividualLocalityOrWard> {
  IndividualLocalityOrWardMapperElement._(super.mapper, super.container);

  @override
  Function get decoder => decode;
  IndividualLocalityOrWard decode(dynamic v) =>
      checkedType(v, (Map<String, dynamic> map) => fromMap(map));
  IndividualLocalityOrWard fromMap(Map<String, dynamic> map) =>
      IndividualLocalityOrWard(
  ...
  @override
  Function get encoder => encode;
  dynamic encode(IndividualLocalityOrWard v) => toMap(v);
  Map<String, dynamic> toMap(IndividualLocalityOrWard i) => {
        'code': container.$enc(i.code, 'code'),
        'pincode': container.$enc(i.pincode, 'pincode')
      };

  @override
  String stringify(IndividualLocalityOrWard self) =>
      'IndividualLocalityOrWard(code: ${container.asString(self.code)}, pincode: ${container.asString(self.pincode)})';
  @override
  int hash(IndividualLocalityOrWard self) =>
      container.hash(self.code) ^ container.hash(self.pincode);
  @override
  bool equals(IndividualLocalityOrWard self, IndividualLocalityOrWard other) =>
      container.isEqual(self.code, other.code) &&
      container.isEqual(self.pincode, other.pincode);
}

mixin IndividualLocalityOrWardMappable {
  String toJson() => IndividualLocalityOrWardMapper.container
      .toJson(this as IndividualLocalityOrWard);
  Map<String, dynamic> toMap() => IndividualLocalityOrWardMapper.container
      .toMap(this as IndividualLocalityOrWard);
  IndividualLocalityOrWardCopyWith<IndividualLocalityOrWard,
          IndividualLocalityOrWard, IndividualLocalityOrWard>
      get copyWith => _IndividualLocalityOrWardCopyWithImpl(
          this as IndividualLocalityOrWard, $identity, $identity);
  @override
  String toString() => IndividualLocalityOrWardMapper.container.asString(this);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (runtimeType == other.runtimeType &&
          IndividualLocalityOrWardMapper.container.isEqual(this, other));
  @override
  int get hashCode => IndividualLocalityOrWardMapper.container.hash(this);
}

extension IndividualLocalityOrWardValueCopy<$R,
        $Out extends IndividualLocalityOrWard>
    on ObjectCopyWith<$R, IndividualLocalityOrWard, $Out> {
  IndividualLocalityOrWardCopyWith<$R, IndividualLocalityOrWard, $Out>
      get asIndividualLocalityOrWard => base
          .as((v, t, t2) => _IndividualLocalityOrWardCopyWithImpl(v, t, t2));
}

typedef IndividualLocalityOrWardCopyWithBound = IndividualLocalityOrWard;

abstract class IndividualLocalityOrWardCopyWith<
        $R,
        $In extends IndividualLocalityOrWard,
        $Out extends IndividualLocalityOrWard>
    implements ObjectCopyWith<$R, $In, $Out> {
  IndividualLocalityOrWardCopyWith<$R2, $In, $Out2>
      chain<$R2, $Out2 extends IndividualLocalityOrWard>(
          Then<IndividualLocalityOrWard, $Out2> t, Then<$Out2, $R2> t2);
  $R call({String? code, String? pincode});
}

class _IndividualLocalityOrWardCopyWithImpl<$R,
        $Out extends IndividualLocalityOrWard>
    extends CopyWithBase<$R, IndividualLocalityOrWard, $Out>
    implements
        IndividualLocalityOrWardCopyWith<$R, IndividualLocalityOrWard, $Out> {
  _IndividualLocalityOrWardCopyWithImpl(super.value, super.then, super.then2);
  @override
  IndividualLocalityOrWardCopyWith<$R2, IndividualLocalityOrWard, $Out2>
      chain<$R2, $Out2 extends IndividualLocalityOrWard>(
              Then<IndividualLocalityOrWard, $Out2> t, Then<$Out2, $R2> t2) =>
          _IndividualLocalityOrWardCopyWithImpl($value, t, t2);

  @override
  $R call({Object? code = $none, Object? pincode = $none}) =>
      $then(IndividualLocalityOrWard(
          code: or(code, $value.code), pincode: or(pincode, $value.pincode)));
}
