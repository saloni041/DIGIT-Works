...
import 'package:flutter_training/blocs/individual/create_individual_bloc.dart';
import 'package:flutter_training/blocs/individual/search_individual_bloc.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => CreateIndividualBloc()),
        BlocProvider(create: (context) => SearchIndividualBloc()),
      ],
