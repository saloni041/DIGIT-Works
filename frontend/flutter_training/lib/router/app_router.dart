...
import 'package:flutter_training/pages/individual/search_individual.dart';
import 'package:flutter_training/pages/individual/view_individual_details.dart';
...
import '../pages/individual/create_individual.dart';
  ...
  routes: [
    ...
    AutoRoute(
      ...
      children: [
        ...
        AutoRoute(page: CreateIndividualPage, path: 'create-individual'),
        AutoRoute(page: SearchIndividualPage, path: 'search-individual'),
        AutoRoute(page: ViewIndividualPage, path: 'view-individual')
      ],
    ),
  ],
)
